...
class Solution {
    public String solution(String[] survey, int[] choices) {
        ...
        for(int i = 0, choLength = choices.length; i < choLength; i++){
        ...
        for(int i = 0, typeLength = typeArr.length; i < typeLength; i++){
            String type1 = typeArr[i][0];
            String type2 = typeArr[i][1];
